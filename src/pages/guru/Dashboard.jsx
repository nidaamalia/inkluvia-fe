          ...
          <div className="mb-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
              ...
              <div className="relative w-full sm:w-64">
                ...
                <Input
                  ...
                  aria-label="Cari jadwal berdasarkan materi atau status"
                />
            ...
            <div className="overflow-x-auto">
              <table className="table" role="table" aria-label="Jadwal belajar siswa">
                <caption className="sr-only">Daftar jadwal belajar untuk {selectedStudent}</caption>
                <thead className="table-header">
                  <tr>
                    <th scope="col" id="col-date">Tanggal</th>
                    <th scope="col" id="col-time">Jam</th>
                    <th scope="col" id="col-material">Materi</th>
                    <th scope="col" id="col-status">Status</th>
                    <th scope="col" id="col-action">Aksi</th>
                  </tr>
                </thead>
                <tbody className="table-body">
                  {filteredSchedules.map((schedule) => (
                    <tr key={schedule.id} className="table-row">
                      <td className="table-cell" headers="col-date">{schedule.date}</td>
                      <td className="table-cell" headers="col-time">{schedule.time}</td>
                      <td className="table-cell" headers="col-material">{schedule.material}</td>
                      <td className="table-cell" headers="col-status">
                        <span
                          className={`badge ${schedule.status === 'SELESAI'
                            ? 'badge-success'
                            : 'badge-pending'
                            }`}
                      ...
                      <td className="table-cell" headers="col-action">
                        <Button
                          variant="outline"
                          size="sm"
                          onClick={() => handleViewMaterial(schedule.id)}
                          className="text-blue-600 border-blue-300 hover:bg-blue-50"
                          aria-label={`Lihat materi untuk ${schedule.material}`}
                        >
                          LIHAT MATERI
                        </Button>
                      </td>
            ...
            <div className="mt-6 flex items-center justify-between">
              ...
              <div className="flex items-center space-x-1">
                ...
                <span
                  className="inline-flex items-center justify-center w-8 h-8 bg-primary-600 text-white text-sm font-medium rounded"
                  aria-current="page"
                >
                  1
                </span>
